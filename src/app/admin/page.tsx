...
type AdminView = "overview" | "dispatch" | "orders" | "people" | "cases" | "operations" | "activity";
...
const adminViews = new Set<AdminView>(["overview", "dispatch", "orders", "people", "cases", "operations", "activity"]);
