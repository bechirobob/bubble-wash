...
const customerFlow = [
  ...
  ["You see the handoff", "Tracking, map links, and alerts keep the pickup-to-delivery trail visible."],
];
  ...
  return (
    <main>
      ...
      <section id="services" className="section humanFlowSection compactHumanFlowSection">
        <div className="sectionHead narrow compactHead"><p className="eyebrow">How it works</p><h2>Laundry should feel handled, not like another errand.</h2><p>The homepage keeps the story short. Use the menu for pricing, coverage, tracking, FAQs, and staff access when you actually need them.</p></div>
      ...
      <section id="menu-desk" className="section menuDeskSection soft" aria-labelledby="menu-desk-heading">
        <div className="sectionHead compactHead"><p className="eyebrow">Menu desk</p><h2 id="menu-desk-heading">Useful details open only when selected.</h2><p>Pricing, coverage, tracking, questions, and staff access still work — they just stop crowding the default homepage.</p></div>
        ...
        {activeMenuPanel === "staff" && <div className="menuPanelContent" role="tabpanel" aria-label="Staff workspace links"><div className="staffCards compactStaffCards"><a className="staffCard" href="/login?next=/admin"><span>01</span><h3>Admin</h3></a><a className="staffCard" href="/login?next=/vendors"><span>02</span><h3>Vendor</h3></a><a className="staffCard" href="/login?next=/drivers"><span>03</span><h3>Driver</h3></a><a className="staffCard" href="/login?next=/support"><span>04</span><h3>Support</h3></a></div></div>}
      </section>
