    ...
    <PublicChrome>
      <section className="laundryIntro pageShell" id="main-content" aria-labelledby="home-title">
        <div className="laundryIntroCopy">
          ...
          <h1 id="home-title">Laundry pickup<br />for your business.</h1>
      ...
      <section className="laundryServices pageShell" aria-labelledby="service-heading"><div><p className="sectionLabel">Choose your service</p><h2 id="service-heading">For work. Soon, for home.</h2></div><div className="serviceRows"><article><div><h3>Business laundry</h3><p>Regular pickups for restaurants, offices, guest stays and facilities.</p></div><Link className="textAction" href="/services">Compare plans <ArrowRight aria-hidden="true" /></Link></article><article><div><h3>Household laundry</h3><p>Home pickups are coming to Accra. Join the early-access list.</p></div><Link className="textAction" href="/early-access">Join early access <ArrowRight aria-hidden="true" /></Link></article></div></section>
    </PublicChrome>
  );
}
