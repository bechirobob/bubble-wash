  ...
  return (
    <PublicChrome skipTo="early-access" skipLabel="Skip to early access">
      <section className="homeHero pageShell earlyAccessHero" aria-labelledby="early-title">
        <div className="homeHeroCopy"><House className="pageIntroIcon" aria-hidden="true" /><p className="sectionLabel">Household laundry · Accra</p><h1 id="early-title">Household laundry is coming.</h1><p className="lead">Fresh laundry, picked up and delivered to your door. Household service is coming to Accra. Join early access to help shape our first pickup routes.</p><dl className="recordList earlyAccessPromises"><div><dt>Pickup</dt><dd>From your home</dd></div><div><dt>Care</dt><dd>Professional cleaning</dd></div><div><dt>Updates</dt><dd>One order reference</dd></div></dl></div>
        <EarlyAccessForm />
      </section>
