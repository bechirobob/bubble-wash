  ...
  return (
    <section className="serviceSection pageShell bookingPageSection" aria-labelledby="booking-form-heading">
      ...
      <form className="bookingForm serviceForm" onSubmit={submitBooking}>
        ...
        <label className="termsCheck"><input type="checkbox" required /><span>I agree to the <a href="/terms" target="_blank">service terms</a> and <a href="/privacy" target="_blank">privacy notice</a>. I understand that intake weight may change the estimate and the collection window requires confirmation.</span></label>
